...
# ## **Adenocarcinoma Semantic Segment Pretrained PSPNet**
...
# define model
model = PSPNet(BACKBONE, encoder_weights='imagenet',classes=1, input_shape=(H, W, CH), activation='softmax', 
               weights=None,  encoder_freeze=False, downsample_factor=8, psp_conv_filters=512,
...
plot_results_for_one_sample(70)
...
#Show predicted result---------------
plot_results_for_one_sample(26)
