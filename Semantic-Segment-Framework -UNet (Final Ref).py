...
# ## **Semantic Segment Pretrained Unet**
...
model = Unet(BACKBONE, encoder_weights='imagenet',classes=1, input_shape=(H, W, CH), encoder_features='default',
             activation='sigmoid', weights=None, encoder_freeze=False,  decoder_use_batchnorm=True, 
             decoder_block_type='upsampling',decoder_filters=(256, 128, 64, 32, 16)
            )
