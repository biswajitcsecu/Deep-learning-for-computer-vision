...
model = smp.Unet('resnet34', encoder_weights='imagenet', classes=n_classes, decoder_use_batchnorm=True, in_channels=3,
...
#metrics
def mIoU(pred_mask, mask, smooth=1e-10, classes=n_classes):
    with torch.no_grad():
...
ax3.set_title('UNet-ResnetNet | rIoU {:.3f}'.format(score))
ax3.set_axis_off()
plt.show()
...
ax3.set_title('UNet-ResnetNet | rIoU {:.3f}'.format(score2))
ax3.set_axis_off()
plt.show()
...
ax3.set_title('UNet-ResnetNet | rIoU {:.3f}'.format(score3))
ax3.set_axis_off()
plt.show()
...
ax3.set_title('UNet-ResnetNet | rIoU {:.3f}'.format(score4))
ax3.set_axis_off()
plt.show()
...
ax3.set_title('UNet-ResnetNet | rIoU {:.3f}'.format(scorex))
ax3.set_axis_off()
...
ax4.set_title('Segment-ResnetNet'.format(scorex))
ax4.set_axis_off()
plt.show()
