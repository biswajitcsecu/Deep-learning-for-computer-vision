...
model.compile(optimizer=Adam(learning_rate=1e-4),loss=[perceptual_loss],metrics=[PSNR,'accuracy',SSIM]) 
#model.compile(optimizer=Adam(learning_rate=1e-4),loss=['mean_squared_error','MSE'],metrics=['accuracy',iou]) #
