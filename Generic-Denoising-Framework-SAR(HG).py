...
# ## **SAR Denoising  using DCNN Framework**
...
train_files=['SAR/train/images/'+filename for filename in os.listdir('SAR/train/images/')]
test_files=['SAR/test/images/'+filename for filename in os.listdir('SAR/test/images/')]
