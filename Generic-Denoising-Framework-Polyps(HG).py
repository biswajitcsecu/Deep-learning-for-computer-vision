...
# ## **Polyps Denoising  using DCNN Framework**
...
train_files=['Polyps/train/images/'+filename for filename in os.listdir('Polyps/train/images/')]
test_files=['Polyps/test/images/'+filename for filename in os.listdir('Polyps/test/images/')]
...
history=rpdnet.fit( train_dataset,shuffle=True,epochs=nepochs,
                   ...
                   max_queue_size=4,workers=1,verbose=1,
